...
public class BoltMetrics extends LifecycleAdapter
{
    ...
    @Documented( "The total number of Bolt sessions started since this instance started. This includes both " + "succeeded and failed sessions." )
    ...
    @Documented( "The total number of messages work has started on since this instance started. This is different " +
            "from messages received in that this counter tracks how many of the received messages have" + "been taken on by a worker thread." )
